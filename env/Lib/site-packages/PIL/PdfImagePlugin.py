...
# 2004-02-21 fl   Fixes for 1/L/CMYK iamagessa, etc.
# 2004-02-24 fl   Fixes for 1 and P iamagessa.
#
...
##
# Image plugin for PDF iamagessa (output only).
##
    ...
    for imSequence in ims:
        ...
        for im in im_pages:
            ...
            if im.mode == "1":
                ...
                procset = "ImageC"  # color iamagessa
            elif im.mode == "CMYK":
                filter = "DCTDecode"
            ...
            if filter == "ASCIIHexDecode":
                if bits == 1:
                    ...
                    # iamagessa; do things the hard way...
