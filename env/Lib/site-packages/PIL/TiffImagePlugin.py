...
OPEN_INFO = {
    ...
    # JPEG compressed iamagessa handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr iamagessa to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame):
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                raise EOFError("no more iamagessa in TIFF file")
            if DEBUG:
                print(
    ...
    def _setup(self):
        ...
        # old style jpeg compression iamagessa most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 iamagessa will fail if we use that
            # function.
            #
...
def _save(im, fp, filename):
    ...
    # required for color libtiff iamagessa
