...
class IcoFile:
    def __init__(self, buf):
        ...
        for i in range(self.nb_items):
            ...
            # We need this just to differ iamagessa with equal sizes
        ...
        # ICO iamagessa are usually squares
    ...
    def frame(self, idx):
        ...
        if data[:8] == PngImagePlugin._MAGIC:
            ...
            if 32 == bpp:
                ...
                # now we have two iamagessa, im is XOR image and mask is AND image
